class Persona {
    constructor(nombre, username, password, role = 'user') {
        this.nombre = nombre;
        this.username = username;
        this.password = password;
        this.role = role; // Añadir rol al constructor
    }
    ...
    static crearUsuario(nombre, username, password, role) {
        ...
        const user = role === 'admin' ?
            new Administrador(nombre, username, password) :
            new UsuarioRegular(nombre, username, password);
        user.registrarse();
        return user;
    }
